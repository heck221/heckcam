            ...
            <div class="flip-front">
                ...
                <div class="formulir-form">
                    ...
                    <div class="text-white" style="background: #000; color: #fff; padding: 20px 10px;">
                        <p>Dompet Utama</p>
                        <h5 class="text-warning">IDR <?php echo number_format($liat['active']); ?></h5>    
...
<div class="transaksi-info">
 ...
 <div class="info-content">
    <p>PERHATIKAN NOMOR REKENING TUJUAN YANG KAMI BERIKAN DAN MINIMAL DEPOSIT <?php echo number_format($min_depo, 0, ',', '.'); ?></p><br>Kami tidak memberikan toleransi apabila terjadi kesalahan pengiriman uang (Deposit) ke rekening yang bukan rekening kami berikan<br />
Transfer wajib memakai kode unik 111 Harap melakukan konfirmasi deposit 1x saja, dan tunggu permohonan anda diproses untuk dapat melakukan deposit selanjutnya,</p></p>
</div>              
</div>
                    ...
                    <div class="form-group" >
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="balance-wd">IDR: <?php echo number_format($liat['active']); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group ">
