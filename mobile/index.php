...
<head>
  ...
  <?php
  } else if ($warna == "biru-aqua") {
  ?>
    <link rel="stylesheet" id="templateStyle" type="text/css" href="biru-aqua/custom/css/style.css">
  <?php
  }
  ?>
...
<body>
            ...
            <div class="header-form">
              ...
              ?>
                <div class="mobile-button--transaksi" href="#" data-toggle="modal" data-target="#accountBalance">
                  <a class="wallet-amount" id="wallet-amount"><i class="fas fa-coins m-auto"></i> IDR <span name="mainBalance"><?php echo number_format($liat['active']); ?></span></a>
                </div>
                <button data-target="slide-out" class="btn-daftar sidenav-toggle btn-sm"><i class="fas fa-bars"></i></button>
              <?php
              }
  ...
  <div class="header-mobile">
    <div class="header-mobile__top">
      ...
      <div class="mobile-button">
        ...
        if ($id_login == true) {
        ?>
        <div class="mobile-button--menu" style="">
          <a href="#" name="refreshWallet" onclick='tarikSaldo()'><span><i class="fa fa-sync" style="color: black"></i></span></a>
        </div>
        
          <div class="mobile-button--transaksi" href="#" data-toggle="modal" data-target="#accountBalance">
            <i class="fas fa-coins m-auto"></i> IDR
            <a class="wallet-amount" id="wallet-amount"><span name="mainBalance"><?php echo number_format($liat['active']); ?></span></a>
          </div>
  ...
  }  else if ($_GET['page'] == "slot_greentube") {
    include 'template/page/menu_game/slot/greentube.php';
  } else if ($_GET['page'] == "slot_relax") {
    include 'template/page/menu_game/slot/relax.php';
  }  else if ($_GET['page'] == "slot_pushgaming") {
    include 'template/page/menu_game/slot/pushgaming.php';
  }  else if ($_GET['page'] == "slot_spinomenal") {
    include 'template/page/menu_game/slot/spinomenal.php';
  }  else if ($_GET['page'] == "slot_3oaksgaming") {
    include 'template/page/menu_game/slot/3oaks.php';
  } 
  ...
  <div class="footer-mobile">
    ...
    if ($id_login == false) {
    ?>
      <a class="footer-item" href="../uploads/apk/Dewa MPO_1_1.0.apk">
    ...
    ?>
      <script type="text/javascript">
        Swal.fire({
          icon: 'error',
          title: 'Opps',
          text: 'Hubungi Admin Untuk Mengakses Game!'
        });
      </script>
  <?php
    }
    ...
    ?>
      <script type="text/javascript">
        Swal.fire({
          icon: 'success',
          title: 'Selamat',
          text: 'Terimakasih Sudah verifikasi Akun Anda Silahkan Tunggu Untuk Konfirmasi Akun!'
        });
      </script>
  <?php
    }
    ...
    ?>
      <script type="text/javascript">
        Swal.fire({
          icon: 'error',
          title: 'Yah!',
          text: 'Verifikasi Akun Anda Gagal'
        });
      </script>
  <?php
    }
