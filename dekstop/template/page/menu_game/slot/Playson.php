    ...
    <div class="main-content slot-game">
        <div class="container">
            <div class="slot-game__container">
                <div class="page-header">Playson</div>
                <div class="slot-game-list">
                    ...
                    $query = mysqli_query($koneksi, "SELECT * FROM game_table WHERE provider = '$id_provider' ");
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                          ...
                          if($cek > 0){
                            ...
                            if ($id_login == '') {
                                $link_url = 'index.php?pesan=28';
                                 ...
                                 $link_url = $urlweb . '/main/API/playGame.php?extplayer='.$extplayer.'&gameCode='.$row['game_code'].'&provider='.$row['provider'];
                            }
                        ...
                        <div class="slot-game-item slot-tg" style="display: block;">
                            <div class="slot-game-img">
                                <img src="<?php echo $row['banner'] ?>" style="">
                            </div>
